namespace OAuthCSharp
{
    ...
    public static class OAuthConsumer
    {
        ...
        private static T MakeRequest<T>(string endPoint, AuthorizeHeader authorizationHeader) where T : TokenBase, new()
        {
        ...
        public static RequestToken GetOAuthRequestToken(string requestTokenEndpoint, string realm, string consumerKey, string consumerSecret, string callback, SignatureMethod signatureMethod = SignatureMethod.HMACSHA1)
        {
        ...
        public static AccessToken GetOAuthAccessToken(string accessTokenEndpoint, string realm, string consumerKey, string consumerSecret, string token, string verifier, string tokenSecret, SignatureMethod signatureMethod = SignatureMethod.HMACSHA1)
        {
        ...
        public static string GetUserInfo(string userInfoEndpoint, string realm, string consumerKey, string consumerSecret, string token, string tokenSecret, SignatureMethod signatureMethod = SignatureMethod.HMACSHA1)
        {
